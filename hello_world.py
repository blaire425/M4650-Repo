...
print(str + " my name is Yunzhou Li and I am a pusher, and I am standing still")
print(str + " my name is Liam Flannagan")
print(str + " my name is Ge Feng and I'm a pusher,and I'm standing still.")
...
print(str + " my name is Zack Foreman and I'm a pusher")
